...
[X] Uma área em formato de código (JSON) que mostra em tempo real as variáveis invisíveis que afetam a UI: activeHandIndex, o tamanho atual do playerHands, e o score atual do Dealer. Isso mata a dúvida se o erro é visual (Tailwind/React) ou estrutural (Engine)
